...
function makeEmptyData() {
  // { "1": { title:"", rating:"", notes:"" }, ... }
  return Array.from({ length: DAYS }, (_, i) => String(i + 1)).reduce(
    (acc, d) => ((acc[d] = { title: "", rating: "", notes: "" }), acc),
    {}
  );
}
...
export default function App() {
  ...
  const [selectedDay, setSelectedDay] = useState(null); // "1".."24" or null
            ...
            <>
              ...
              <label className="field">
                ...
                <textarea
                  ...
                  placeholder="Optional thoughts or who you're watching with…"
                />
              </label>
            </>
          ) : (
